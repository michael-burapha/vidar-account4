...
class InvoicingTest extends TestCase
{
    ...
    public function test_can_create_an_export_invoice_with_fx_snapshot(): void
    {
        ...
        // CBU rate so the base-currency (UZS) total can be computed.
        ExchangeRate::create([
            'currency_id' => $usd->id,
    ...
    public function test_it_park_fund_is_one_percent_of_invoiced_base(): void
    {
        ...
        Invoice::create([
            ...
            'total' => 1000,
            'exchange_rate' => 12000,
            'total_base' => 12_000_000,
        ]);

        $result = app(ItParkFundCalculator::class)->forMonth(2026, 6);

        $this->assertEquals(12_000_000, $result['invoiced_base']);
        $this->assertEquals(120_000, $result['fund_contribution']); // 1%
